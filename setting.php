    ...
    <?php foreach ($result as $row) : ?>
      <header class="header" id="header">
        ...
        <div class="header_img">
          <?php
          $profileImage = ($row['photo'] !== null) ? $row['photo'] : 'https://via.placeholder.com/150';
          ?>
      ...
      <div class="content-wrapper">
        ...
        <div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <img src="<?= $row['photo'] ?>" class="rounded-circle" alt="Profile Image" style="width: 130px; height: 130px;">
              ...
              <form action="process_edit.php" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                  <div class="mt-3">
                    ...
                    <img src="<?= $row['photo'] ?>" class="card-img-top rounded-circle" alt="Profile Image" style="width:130px;height:130px">
    ...
    <?php if ($notification !== null) : ?>
      <script>
        $(document).ready(function() {
          $('#notificationModal .modal-content').html('<?php echo addslashes($notification); ?>');
